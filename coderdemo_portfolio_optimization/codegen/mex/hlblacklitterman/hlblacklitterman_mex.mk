START_DIR = /Users/User/Desktop/Thesis-Final/coderdemo_portfolio_optimization

MATLAB_ROOT = /Applications/MATLAB_R2013a.app
MAKEFILE = hlblacklitterman_mex.mk

include hlblacklitterman_mex.mki


SRC_FILES =  \
	hlblacklitterman_mexutil.c \
	hlblacklitterman_data.c \
...
MEX_FILE_NAME_WO_EXT = hlblacklitterman_mex
...
SYS_INCLUDE += -I "$(START_DIR)/codegen/mex/hlblacklitterman"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/hlblacklitterman/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/hlblacklitterman/%.cu
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/hlblacklitterman/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
